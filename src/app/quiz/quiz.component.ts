...
export class QuizComponent {
  ...
  finish() {
    ...
    // сохраняем результат в сессии, чтобы /result мог подхватить
...
//   questions: Question[] = [
//     { text: 'Сколько воды вы выпиваете в день?', options:[
//       {text:'Менее 1 литра', value:3},{text:'1–1.5 литра', value:2},{text:'1.5–2 литра', value:1},{text:'Более 2 литров', value:0}
//     ]},
//     { text: 'Как часто вы едите сладкое?', options:[
//       {text:'Каждый день',value:3},{text:'3–4 раза в неделю',value:2},{text:'1–2 раза в неделю',value:1},{text:'Почти не ем',value:0}
//     ]},
//     { text: 'Сколько порций овощей/фруктов вы съедаете в день?', options:[
//       {text:'0–1 порция',value:3},{text:'2 порции',value:2},{text:'3 порции',value:1},{text:'4 и более порций',value:0}
//     ]},
//     { text: 'Как часто вы едите после 21:00?', options:[
//       {text:'Каждый день',value:3},{text:'3–4 раза в неделю',value:2},{text:'1–2 раза в неделю',value:1},{text:'Почти никогда',value:0}
//     ]},
//     { text: 'Как часто вы пьёте кофе?', options:[
//       {text:'Не пью',value:0},{text:'1–2 чашки в день',value:1},{text:'Более 2 чашек в день',value:2}
//     ]},
//     { text: 'Как часто вы пьёте энергетики?', options:[
//       {text:'Не пью',value:0},{text:'1 банка в неделю',value:2},{text:'2+ банок в неделю',value:3}
//     ]},
//     { text: 'Как часто вы переедаете за один приём пищи?', options:[
//       {text:'Очень часто',value:3},{text:'Иногда',value:2},{text:'Редко',value:1},{text:'Почти никогда',value:0}
//     ]},
//     { text: 'Насколько стабилен ваш сон?', options:[
//       {text:'Очень нестабилен',value:3},{text:'Есть проблемы',value:2},{text:'В целом стабилен',value:1},{text:'Хороший и стабильный',value:0}
//     ]},
//     { text: 'Как часто вы занимаетесь физической активностью?', options:[
//       {text:'Не занимаюсь',value:3},{text:'1 раз в неделю',value:2},{text:'2–3 раза в неделю',value:1},{text:'Более 3 раз в неделю',value:0}
//     ]},
//     { text: 'Много ли в вашем рационе ультра-переработанных продуктов?', options:[
//       {text:'Очень много',value:3},{text:'Много',value:2},{text:'Немного',value:1},{text:'Почти нет',value:0}
//     ]},
//     { text: 'Чувствуете ли вы резкие перепады энергии в течение дня?', options:[
//       {text:'Очень часто',value:3},{text:'Иногда',value:2},{text:'Редко',value:1},{text:'Почти никогда',value:0}
//     ]},
//     { text: 'Как часто вы едите фастфуд?', options:[
//       {text:'Каждый день',value:3},{text:'1–2 раза в неделю',value:2},{text:'1 раз в 2 недели',value:1},{text:'Почти никогда',value:0}
//     ]},
//     { text: 'Как часто вы едите крупные порции углеводов (паста/булки/белый хлеб)?', options:[
//       {text:'Каждый день',value:3},{text:'3–4 раза в неделю',value:2},{text:'1–2 раза в неделю',value:1},{text:'Редко',value:0}
//     ]},
//     { text: 'Много ли у вас перекусов в течение дня?', options:[
//       {text:'Очень много',value:3},{text:'Много',value:2},{text:'Редко',value:1},{text:'Почти нет',value:0}
//     ]},
//     { text: 'Сколько часов в день вы сидите?', options:[
//       {text:'8+ часов',value:3},{text:'6–8 часов',value:2},{text:'3–5 часов',value:1},{text:'Менее 3 часов',value:0}
//     ]}
//   ];
...
//     const saved = localStorage.getItem('quizAnswers');
//     if (saved) this.answers = JSON.parse(saved);
//     // ensure answers array has length = questions length (fill undefineds)
//     if (this.answers.length < this.questions.length) {
//       for (let i = this.answers.length; i < this.questions.length; i++) this.answers[i] = undefined as any;
//     }
//   }
...
//   finish() {
//     // treat undefined answers as 0 (or you can force user to answer all)
//     const normalized = this.answers.map(v => (typeof v === 'number' ? v : 0));
//     const total = normalized.reduce((sum, v) => sum + v, 0);

//     // get profile (diabetic flag) from localStorage (profile component saves it)
//     const rawProfile = localStorage.getItem('nh_profile');
//     const profile = rawProfile ? JSON.parse(rawProfile) : null;
//     const isDiabetic = profile?.isDiabetic === true;

//     const result = this.rec.getRecommendations(total, isDiabetic);

//     // keep last result in session so /result can be opened direct
//     sessionStorage.setItem('lastResult', JSON.stringify(result));
